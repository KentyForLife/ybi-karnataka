  ...
  return (
    <div className="space-y-8 animate-fadeInUp">
      <div className="bg-gradient-to-r from-brand-50 via-white to-brand-50 rounded-2xl shadow-brand border border-brand-200 p-8">
        <h2 className="text-4xl font-bold text-brand-700 mb-4">About YBI</h2>
        <p className="text-gray-700 leading-relaxed text-lg">
          The Youth Biology Institute, inspires students to explore how engineering principles enhance understanding of the human body. Through our active research department and hands-on workshops with government-school students, we spark curiosity, support learning, and encourage young minds to pursue impactful careers in Biology.
        </p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-md p-8 border border-gray-100">
        ...
        <p className="text-gray-700 leading-relaxed mb-8">
          We believe in the power of open knowledge and collaborative innovation. This platform is a repository of research papers and workshops conducted by our students. Contributors can upload and share their work publicly, creating a vibrant community of researchers and innovators.
        </p>
      ...
      <div className="bg-gradient-to-r from-brand-600 to-brand-700 text-white rounded-2xl shadow-brand-lg p-10">
        ...
        <p className="text-brand-100 mb-8 text-lg">
          Have a research paper or project? Share it with the YBI community and contribute to our collective knowledge.
        </p>
